...
# ----------------------- Public Sector, Taxation, Regulation (RS_GBL) ----------------------- #
# The annual statistical publications present a unique set of detailed and internationally
# comparable tax revenue data in a common format. Its approach is based on the well-established methodology
# of the OECD Revenue Statistics (OECD, 2017), which has become an essential reference. It provides a conceptual
# framework defining which government receipts should be regarded as taxes and classifies different types of taxes.
# Comparable tables show revenue data by type of tax in national currency, as a percentage of GDP, and, for the different
# types of taxes, as a share of total taxation. Comparisons are also made with the averages of the 35 OECD economies,
# of the 24 LAC countries (two of which are OECD members countries° and of 16 African countries.
# The data set does not replace the other publications, and users are advised to consult the regional data sets for
# country specific information.

# Data importing
dataset_identifier = "RS_GBL"
